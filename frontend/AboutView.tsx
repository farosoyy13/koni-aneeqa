    ...
    <div style={{ padding: '20px', maxWidth: '750px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      <div style={{ background: '#111', padding: '40px 30px', borderRadius: '16px', border: '1px solid #d4af37', textAlign: 'right', boxShadow: '0 5px 25px rgba(212,175,55,0.08)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', fontSize: '14px', color: '#eee', lineHeight: '2' }}>
          ...
          <p><strong>• تـاريـخ الـتـأسـيـس:</strong> تم تأسيس وتدشين هذا الصرح الرقمي الشامل رسمياً وبصيغة معتمدة عبر الإنترنت in عام <b>2020 م</b> لخدمة عملاء النخبة في المملكة العربية السعودية ودول الخليج العربي.</p>
