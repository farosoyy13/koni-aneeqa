...
export function Navbar() {
  ...
  const navLinks = [
    { href: "/", label: "الرئيسية" },
    { href: "/dresses", label: "التشكيلة كاملة" },
  ...
  return (
    <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/">
            <div className="flex flex-col items-center justify-center cursor-pointer">
              <h1 className="text-3xl font-bold font-serif text-primary tracking-wider">كوني أنيقة</h1>
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <Link href="/cart">
              <div className="relative p-2 text-foreground hover:text-primary transition-colors cursor-pointer group">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-border animate-in fade-in slide-in-from-top-4">
