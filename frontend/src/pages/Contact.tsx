    ...
    <div className="min-h-screen bg-[#050505] text-white pt-12 pb-24 selection:bg-[#d4af37]">
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        <div className="text-center mb-16 space-y-4">
          ...
          <h1 className="text-5xl font-bold font-serif text-[#d4af37]">تواصل مع أناقة CHIC</h1>
          <p className="text-gray-400 italic">نحن هنا لخدمة ذوقك الرفيع وجمالك الحصري</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-[#111] border border-[#333] rounded-3xl p-8 md:p-12 shadow-2xl hover:border-[#d4af37] transition-colors duration-500">
            <h2 className="text-2xl font-bold mb-8 text-[#d4af37]">رسالتكِ الملكية</h2>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField control={form.control} name="name" render={({ field }) => (
                  <FormItem><FormControl><Input placeholder="الاسم الكريم" {...field} className="bg-[#050505] border-[#333] h-12 focus:border-[#d4af37]" /></FormControl></FormItem>
                )}/>
                ...
                <FormField control={form.control} name="message" render={({ field }) => (
                  <FormItem><FormControl><Textarea placeholder="اكتبي استفساركِ الراقي هنا.." className="bg-[#050505] border-[#333] h-32 focus:border-[#d4af37] resize-none" {...field} /></FormControl></FormItem>
                )}/>
